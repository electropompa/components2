  ...
  <div class="container">
    <div class="block-shift__grid">
      ...
      <div class="block-shift__desc">
        <p>Поддержание полного ассортимента товаров и зап частей в наличии на собственном складском комплексе площадью
          более 1500 м<sup>2</sup> позволяет комплектовать заказы любой сложности в самые короткие сроки.</p>
        <p>Региональным покупателям бесплатно доставим товар до терминалов транспортноых компаний в г. Москве.</p>
        <p>Услуги гарантийного и постгарантийного обслужвания, ремонтные работы по замене зап. частей осуществляет
          Сервисная служба ГК Электропомпа.</p>
      </div>
